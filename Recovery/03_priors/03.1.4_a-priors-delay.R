...
tmpP1.1= grep("a.asym",theta.names,perl=TRUE)
tmpP1.2 = grep("a.start",theta.names,perl=TRUE)
tmpP1.3 = grep("a.rate",theta.names,perl=TRUE)
tmpP1.4 = grep("a.delay",theta.names,perl=TRUE)
