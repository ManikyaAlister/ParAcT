...
par(mfrow = c(2, 3))
cor = cor(allGenParams$a.c, allMeanTheta$a.c)
plot(allGenParams$a.c, allMeanTheta$a.c, xlab = "Generating", ylab = "Estimated", sub = paste0("r = ", round(cor, 2)), main = "a c (intercept)")
cor = cor(allGenParams$a.b, allMeanTheta$a.b)
plot(allGenParams$a.b, allMeanTheta$a.b, xlab = "Generating", ylab = "Estimated", sub = paste0("r = ", round(cor, 2)), main = "a b (slope)")
...
plot(allGenParams$v, allMeanTheta$v, xlab = "Generating", ylab = "Estimated", sub = paste0("r = ", round(cor, 2)), main = "a")
