...
for (p in 1:n) { #Loop in each data set
  load(here(paste0("Recovery/",model,"/Fits_recovery/P",p,"_",model,".RData")))
...
cor(allGenParams$a.asym, allMeanTheta$a)
)
...
plot(allGenParams$a.asym, allMeanTheta$a, ylab = "Estimated", xlab = "Generated", main = "a recovering a asymtope")
plot(allGenParams$v, allMeanTheta$v, ylab = "Estimated", xlab = "Generated", main = "v")
