---
title: "PaRacT knowlesetal-19 Data"
...
library(here)
library(gridExtra)
source(here("modelling/knowlesetal-19/08_param-plot-functions.R"))
```
# Model Comparison
...
What were the best 4 single models? That can inform what 2 parameter models I should run. 
...
Looks like the v-exp-delayed was actually the best single model.
...
Followed by v-pow-delayed. Seems like the v models are all doing better than the a models. But what a models performed best? 
...
second best a model is a-pow

#### What 2-parameter change models should I run?

It seems like the delay functions best describe the v- models, but the a- models are better described by the normal power/exponential models. So, I think the best 2 param models to run would be: 
...
```{r}
source(here("modelling/knowlesetal-19/11_model-fits.R"))
