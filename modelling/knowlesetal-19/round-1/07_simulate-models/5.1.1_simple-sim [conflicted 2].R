...
for(useSub in 1:nSub) {
  ...
  load(here(paste("modelling/knowlesetal-19/round-1/06_output/P",useSub,"_simple.Rdata", sep = ""))) #Loads through the datasets of each participant in nSub
  ...
  save(sim, file = here(paste("modelling/knowlesetal-19/round-1/08_model-predictions/P",useSub,"_simple.Rdata", sep = "")))
