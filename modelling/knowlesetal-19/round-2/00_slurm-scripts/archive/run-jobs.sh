...
cd /data/gpfs/projects/punim1751/ParAcT/modelling/knowlesetal-19/00_slurm-scripts
...
sbatch  sbatch-script-3.3.txt
sbatch  sbatch-script-3.4.txt
sbatch  sbatch-script-3.5.txt
sbatch  sbatch-script-3.6.txt
