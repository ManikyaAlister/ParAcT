...
both_blocked_2p <- c(FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, TRUE, FALSE)
mixed_blocked_2p <- c(FALSE, FALSE, TRUE, FALSE, TRUE, FALSE, FALSE, TRUE)
...
save(n_param_comparison_weights_AIC, file = here("data/knowlesetal-19/derived/n_param_comparison_AIC.Rdata"))
save(n_param_comparison_weights_BIC, file = here("data/knowlesetal-19/derived/n_param_comparison_BIC.Rdata"))
...
both_blocked_models <-  models_2p[both_blocked_2p] # models where both processes are blocked processes
models_1p <- c(v_models, a_models)
...
mixed_models <- models_2p[mixed_blocked_2p]
...
save(weighted_blockVtrial_BIC, file = here("data/knowlesetal-19/derived/blockVtrial_BIC.Rdata"))
save(weighted_blockVtrial_AIC, file = here("data/knowlesetal-19/derived/blockVtrial_AIC.Rdata"))
