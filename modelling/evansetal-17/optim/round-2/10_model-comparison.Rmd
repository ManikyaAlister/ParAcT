...
best_BIC <- rankBIC[, 1]
save(best_BIC, file = here("data/evansetal-17/derived/optim/best_BIC"))
best_AIC <- rankAIC[, 1]
save(best_AIC, file = here("data/evansetal-17/derived/optim/best_AIC"))
```
