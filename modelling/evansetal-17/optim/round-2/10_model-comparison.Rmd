...
save(models, file = here("data/evansetal-17/derived/optim/all-models.Rdata"))
...
save(n_param_comparison_weights_AIC, file = here("data/evansetal-17/derived/optim/n_param_comparison_AIC.Rdata"))
save(n_param_comparison_weights_BIC, file = here("data/evansetal-17/derived/optim/n_param_comparison_BIC.Rdata"))
