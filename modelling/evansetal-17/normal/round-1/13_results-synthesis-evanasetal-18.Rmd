---
title: "PaRacT evansetal-17 Data"
...
library(here)
library(gridExtra)
source(here("modelling/evansetal-17/08_param-plot-functions.R"))
```
# Model Comparison
...
```{r}
load(here("data/evansetal-17/derived/allAIC.Rdata"))
allAIC[,-1]
...
```{r}
load(here("data/evansetal-17/derived/allBIC.Rdata"))
allBIC[,-1]
...
```{r}
source(here("modelling/evansetal-17/11_model-fits.R"))
