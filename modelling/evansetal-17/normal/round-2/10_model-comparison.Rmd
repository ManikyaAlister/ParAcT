...
save(rankBIC, file = here("data/evansetal-17/derived/normal/rank_BIC.Rdata"))
save(rankAIC, file = here("data/evansetal-17/derived/normal/rank_AIC.Rdata"))


# Get the best model for each participant
best_BIC <- rankBIC[, 1]
save(best_BIC, file = here("data/evansetal-17/derived/normal/best_BIC.Rdata"))
best_AIC <- rankAIC[, 1]
save(best_AIC, file = here("data/evansetal-17/derived/normal/best_AIC.Rdata"))
```
...
round(apply(weighted_simpleVbest_AIC,2, mean),3)
round(apply(weighted_simpleVbest_BIC,2, mean),3)
...
save(n_param_comparison_weights_AIC, file = here("data/evansetal-17/derived/normal/n_param_comparison_AIC.Rdata"))
save(n_param_comparison_weights_BIC, file = here("data/evansetal-17/derived/normal/n_param_comparison_BIC.Rdata"))
...
save(weighted_blockVtrial_BIC, file = here("data/evansetal-17/derived/normal/blockVtrial_BIC.Rdata"))
save(weighted_blockVtrial_AIC, file = here("data/evansetal-17/derived/normal/blockVtrial_AIC.Rdata"))
...
plotWeightedICs(weighted_blockVtrial_AIC, main = "AIC", colours = c("red", "blue", "orange", "green"))
plotWeightedICs(weighted_blockVtrial_BIC, main = "BIC",colours = c("red", "blue", "orange", "green"))
