...
load(here(paste("data/chenetal-18/derived/P",i,"_",model,"-IC.Rdata",sep = "")))
...
save(allAIC, file = here("data/chenetal-18/derived/allAIC.Rdata"))
save(allBIC, file = here("data/chenetal-18/derived/allBIC.Rdata"))
